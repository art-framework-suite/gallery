...
public:
  ...
  template <typename T> using HandleT = Handle<T>;
...
template <typename PROD>
inline bool gallery::Event::getByLabel(art::InputTag const &inputTag,
...
inline void gallery::Event::first() { return toBegin(); }
