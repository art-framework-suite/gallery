...
public:
  ...
  BranchData(art::TypeID const& type, TClass* iTClass, TBranch* branch, EventNavigator const* eventNavigator,
             art::EDProductGetterFinder const* finder, std::string&& iBranchName);
  ...
  BranchData&
  operator=(BranchData const&) = delete;

  BranchData&
  operator=(BranchData&&) = delete;
