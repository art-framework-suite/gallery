...
AssnsBranchData::AssnsBranchData(art::TypeID const &type, TClass *iTClass,
                                 TBranch *iBranch,
...
art::EDProduct const *AssnsBranchData::getIt() const { return uniqueProduct(); }

art::EDProduct const *AssnsBranchData::uniqueProduct() const {
